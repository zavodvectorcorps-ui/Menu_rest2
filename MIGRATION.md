...
| База данных (17 коллекций) | 86 KB | `https://recipe-calc-preview.preview.emergentagent.com/api/db-backup/download` |
| Картинки блюд (1019 шт) | 89 MB | `https://recipe-calc-preview.preview.emergentagent.com/api/uploads-backup/download` |
...
curl -o db_backup.tar.gz https://recipe-calc-preview.preview.emergentagent.com/api/db-backup/download

# 2.3 Скачать картинки блюд
curl -o uploads_backup.tar.gz https://recipe-calc-preview.preview.emergentagent.com/api/uploads-backup/download
