...
| База данных (17 коллекций) | 86 KB | `https://table-tracker-28.preview.emergentagent.com/api/db-backup/download` |
| Картинки блюд (1019 шт) | 89 MB | `https://table-tracker-28.preview.emergentagent.com/api/uploads-backup/download` |
...
curl -o db_backup.tar.gz https://table-tracker-28.preview.emergentagent.com/api/db-backup/download

# 2.3 Скачать картинки блюд
curl -o uploads_backup.tar.gz https://table-tracker-28.preview.emergentagent.com/api/uploads-backup/download
